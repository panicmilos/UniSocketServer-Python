...
class Socket(object):
    ...
    def disconnect(self):
        self._ServerDLL.disconnect(self._socket)
    ...
    def _send_to_client(self, data: str):
        self._ServerDLL.send_to_client(self._socket, bytes(self._receivers, 'utf-8'), bytes(data, 'utf-8'))

    def _send_to_clients(self, data: str):
        self._ServerDLL.send_to_clients(self._socket, bytes(self._receivers, 'utf-8'), bytes(data, 'utf-8'))

    def _broadcast(self, data):
        self._ServerDLL.broadcast(self._socket, bytes(data, 'utf-8'))
